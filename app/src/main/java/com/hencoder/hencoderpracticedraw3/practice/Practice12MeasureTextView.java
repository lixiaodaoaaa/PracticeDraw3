...
public class Practice12MeasureTextView extends View{
    ...
    protected void onDraw(Canvas canvas){
        ...
        float marginLeftPoint=55.0f;
        
        
        canvas.drawText(text1, marginLeftPoint, 200, paint1);
        
        
        float text1Width=paint1.measureText(text1);
        canvas.drawText(text2, marginLeftPoint + text1Width, 200, paint2);
        
        
        float text2Width=paint2.measureText(text2);
        canvas.drawText(text3, marginLeftPoint + text1Width + text2Width, 200, paint1);
    }
}
